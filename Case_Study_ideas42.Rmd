...
*Gender*: Both conditions also seem to be balanced in gender, with about 51% of the treatment being female and 52% of the control being the same. The difference, of a little uner 1%, is not statistically significant (p = 0.84).
...
*Age*: The treatment group and hospital have near identitcal average ages (59.6 years), with a negligible difference of 0.003. The difference is not statistically significant (p = 0.99).
...
*Medicaid Eligibility*: About 57% of the treatment group is eligible for Medicaid, while 52% of the hopsital population is. The small difference of 5% in eligible patients is not statistically significant (p = 0.91).
